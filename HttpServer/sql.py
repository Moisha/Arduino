...
def get_info_text(for_html, source):
    ...
    try:
        sql = (f"select dt, dt_server, lamp_state, lamp_mode, temperature, humidity, humidity_target, humidifier_state, co2, fan_state, co2_state"               
               f"  from readings "
...
def write_plot_to_iobytes(wfile, len, height, cnt=1000, source = ""):
    ...
    try:
        ...
        colors = ["k", "r", "c", "b", "y", "g", "m", "chocolate"]
